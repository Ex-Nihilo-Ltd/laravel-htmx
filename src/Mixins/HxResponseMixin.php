...
class HxResponseMixin
{
    public function hxLocation(): Closure
    {
         ...
         */
        return function (string|array $location): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
            $this->header(
    ...
    public function hxRedirect(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string $redirect): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
    ...
    public function hxPushUrl(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string|bool|null $pushUrl = true): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
            $this->header(
    ...
    public function hxReplaceUrl(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string|bool|null $replaceUrl = true): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
            $this->header(
    ...
    public function hxRefresh(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (?bool $refresh = true): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
    ...
    public function hxReswap(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string $swap): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
    ...
    public function hxRetarget(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string $target): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
    ...
    public function hxReselect(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string $select): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
    ...
    public function hxTrigger(): Closure
    {
         ...
         * @return Response|RedirectResponse
         */
        return function (string|array $trigger): Response|RedirectResponse {
            /** @var Response|RedirectResponse $this */
            $this->header(
